...
public class VehiculosTienenAveriasRepositoryImplTest extends AbstractRepositoryImplTest<Long, VehiculosTienenAverias> {
	...
	public VehiculosTienenAverias getInstanceDeTParaLectura() {
		...
		claseVehiculosTienenAverias.setVehiculo(vehiculo2);

		claseVehiculosTienenAverias.setRegistroAverias(registroAverias2);
	...
	public VehiculosTienenAverias getInstanceDeTParaModificar(Long clave) {
		...
		claseVehiculosTienenAverias.setVehiculo(vehiculo3);

		claseVehiculosTienenAverias.setRegistroAverias(registroAverias3);
	...
	private void limpiarBBDD() {
		
		for (VehiculosTienenAverias ventaSacada : sut.list()) {
			sut.delete(ventaSacada);
		}
	}
}
